      ...
      <div className="border-b border-white/10 p-5 sm:p-7">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">Celebrate competitive results, milestones, sportsmanship and the people who make the club better.</p>
          </div>
      ...
      <div className="p-5 sm:p-7">
        {visible.length ? (
          ...
          <div className="rounded-2xl border border-dashed border-white/10 px-6 py-10 text-center">
            ...
            <p className="mt-2 text-sm text-slate-500">{isAdmin ? "Recognise a club member below." : `Club organisers can add achievements here. Browse more from /clubs/${clubSlug}.`}</p>
          </div>
        )}
