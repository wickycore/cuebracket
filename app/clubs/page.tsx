      ...
      <div className="mx-auto max-w-7xl px-5 py-9 sm:px-8 sm:py-12">
        ...
        <section className="mt-9">
          <div className="flex items-end justify-between gap-4">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.22em] text-slate-400">Public directory</p>
              <h2 className="mt-2 text-2xl font-black">Clubs on CueBracket</h2>
            </div>
            <p className="text-sm font-bold text-slate-400">{clubs.length} club{clubs.length === 1 ? "" : "s"}</p>
          </div>
          ...
          {clubs.length ? (
            ...
            <div className="mt-5 rounded-[1.75rem] border border-dashed border-white/10 bg-white/[0.025] p-10 text-center">
              ...
              <p className="mt-2 text-sm text-slate-400">Create the first club and invite your pool community.</p>
            </div>
          )}
        </section>
      </div>
