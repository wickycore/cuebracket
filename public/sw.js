...
self.addEventListener("push", (event) => {
  ...
  const titles = { club_event: "New club event", club_message: "New club update", club_reminder: "Club event reminder", registration_status: "Registration update", membership_status: "Club membership update", match_live: "Your match is live", table_assignment: "Your table is ready", followed_player_live: "A player you follow is live", delivery_test: "Automatic delivery check", test: "CueBracket alerts are working" };
